        ...
        <div id="menuLoggedOut" style="display: none;">\
            <nav>\
                <ul class="nav nav-pills nav-top">\
                    ...
                    <li class="dropdown">\
                        <a class="dropdown-toggle" href="#" data-toggle="dropdown"><i class="icon icon-wrench"></i>Services <i class="icon icon-angle-down"></i></a>\
                        <ul class="dropdown-menu">\
                            <li><a href="/B/' + countryPrefix + '/services.html">Overview</a></li>\
                            <li><a href="/B/' + countryPrefix + '/deliveryService.html">Delivery Service</a></li>\
                            <li><a href="/B/' + countryPrefix + '/assemblyService.html">Assembly Service</a></li>\
                            <li><a href="/B/' + countryPrefix + '/planningGuide.html">Planning Guide Tool</a></li>\
                        </ul>\
                    </li>\
                    <li>\
